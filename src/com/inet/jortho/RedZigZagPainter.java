...
class RedZigZagPainter extends DefaultHighlighter.DefaultHighlightPainter {
	...
	private static final BasicStroke STROKE1 = new BasicStroke(0.01F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10, new float[]{1,3}, 0);
    private static final BasicStroke STROKE2 = new BasicStroke(0.01F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10, new float[]{1,1}, 1);
    private static final BasicStroke STROKE3 = new BasicStroke(0.01F, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10, new float[]{1,3}, 2);
